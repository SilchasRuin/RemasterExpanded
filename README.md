...
### Champion Feats
* [Faithful Steed](https://2e.aonprd.com/Feats.aspx?ID=5885)
* [Oath of the Slayer](https://2e.aonprd.com/Feats.aspx?ID=7519)
* [Oath of the Defender](https://2e.aonprd.com/Feats.aspx?ID=7518)
* [Oath of the Avenger](https://2e.aonprd.com/Feats.aspx?ID=7517) Requires a Good alignment to match the edicts of the feat
* [Divine Health](https://2e.aonprd.com/Feats.aspx?ID=5893) Now functions as per Remaster rules
* [Expand Aura](https://2e.aonprd.com/Feats.aspx?ID=5899) Also includes an Exploration Activity to maintain the effects
* [Smite](https://2e.aonprd.com/Feats.aspx?ID=5901)
* [Spectral Advance](https://2e.aonprd.com/Feats.aspx?ID=5911)
* [Blessed Counterstrike](https://2e.aonprd.com/Feats.aspx?ID=5914)
...
* [Peerless Warden](https://2e.aonprd.com/Feats.aspx?ID=4890)
...
* [Splint Mail](https://2e.aonprd.com/Armor.aspx?ID=48)
...
* Viking grants a 10 foot bonus to speed while underwater instead of improving Swim checks.  
* Mercenary Motivation grants a +1 to 2 skills of your choice and perception for any check rather than applying to all skill checks related to your job.  
* A number of spells are added to the spell schools of Wizards if Remaster Feats and other optional dependencies are present.  
